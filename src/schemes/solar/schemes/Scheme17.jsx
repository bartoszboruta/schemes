...
import { Clock, SvgContainer, SolarPanel, Boiler, Coil, Connector, Pipe, Pump, FlowMeter, ReadField, DateRead, Shower, TriConnector, SingleValve } from '../../../components';
...
class Scheme17 extends Component {
  ...
  render() {
    return <SvgContainer width={459} height={458.1}>
      {this.renderPipes()}
