...
import { Furnace, Clock, SvgContainer, SolarPanel, Boiler, Coil, Connector, Pipe, Pump, FlowMeter, ReadField, Shower, TriConnector } from '../../../components';
...
class Scheme6 extends Component {
  ...
  renderReadFields() {
    return <g>
      ...
      {this.props.data.p134.visible && <ReadField param={'p134'} left={372} top={248.75} />}
      {this.props.data.p136.visible && <ReadField param={'p136'} left={472} top={248.75} />}
    </g>
  }
  ...
  renderFurnace() {
    const active = true;
    return <g transform={'translate('+ 290 + ' ' + 236 +')'}>
      <Coil active={active} />
  ...
  render() {
    return <SvgContainer width={600} height={458.1}>
      {this.renderPipes()}
